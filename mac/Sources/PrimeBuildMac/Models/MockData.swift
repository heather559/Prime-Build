...
enum MockData {
    static let listings: [Listing] = [
        ...
        Listing(
            ...
            imageName: "listing3", status: "Under Contract"
        ),
        Listing(
